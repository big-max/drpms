package com.ibm.smartcloud.core.controller;
...
import com.ibm.smartcloud.core.exception.AuthorizedException;
import com.ibm.smartcloud.core.exception.InternalServerErrorException;
import com.ibm.smartcloud.core.exception.RequestErrorException;
	...
	public ModelAndView resolveException(HttpServletRequest request,
		...
		if (ex instanceof ReturnToLastPageException) {
			...
			try {
				...
				request.setAttribute("message", ex.getMessage());
				return new ModelAndView("home/exception/exception");
			}
		}
