...
/*import com.eigpay.model.BaseObject;
 import com.eigpay.service.IDeleteEntity;
 import com.eigpay.service.IUpdateMassageEntity;
 import com.eigpay.sys.util.AppConst;
 import com.eigpay.sys.util.SpringSecurityUtils;
 import com.eigpay.util.StringUtil;*/
...
public class BaseDao<T, PK extends Serializable> implements IBaseDao<T, PK> {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.eigpay.dao.hibernate.base.IBaseDao#setEntityClass(java.lang
	 * .Class)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.eigpay.dao.hibernate.base.IBaseDao#setPKClass(java.lang.Class)
	 */
	 ...
	 */
	public Page<T, PK> pagedQuery(int pageNo, int pageSize,
			Map<String, String> aliasMap, List<Criterion> filterList,
			List<Order> orderList) {
		return hedao.pagedQuery(pageNo, aliasMap, filterList, orderList,
				pageSize);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.eigpay.dao.hibernate.base.IBaseDao#save(java.lang.Object)
	 */
	...
	// @SuppressWarnings("unchecked")
	/*
	 * public void lastUpdatedMessage(T entity) throws Exception { Date time =
	 * new Date(); String currentUserName =
	 * SpringSecurityUtils.getCurrentUserName(); if(entity instanceof
	 * IUpdateMassageEntity){ IUpdateMassageEntity
	 * object=(IUpdateMassageEntity)entity;
	 * object.setLastUpdatedBy(currentUserName);
	 * object.setLastUpdatedTime(time); }else if(entity instanceof BaseObject){
	 * BaseObject object=(BaseObject)entity; //by dengpeng
	 * if(object.getId()!=null){ BaseObject tbo = (BaseObject)hedao.get((PK)
	 * object.getId()); if(tbo!=null){ object.setCreatedBy(tbo.getCreatedBy());
	 * object.setCreatedTime(tbo.getCreatedTime());
	 * object.setEnabled(tbo.getEnabled()); } }else{
	 * if(!StringUtil.isValidString(object.getCreatedBy())){
	 * object.setCreatedBy(currentUserName); } object.setCreatedTime(time);
	 ...
	 */
	/*
	 * private void disEnabled(T entity) throws Exception { if(entity instanceof
	 * BaseObject){ BaseObject object=(BaseObject)entity;
