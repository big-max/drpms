...
//			date = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(d);
	...
	public static void main(String[] args) {
		System.out.println(kbFormatMb(2*1024*1024 + 1024 + 111));
		System.out.println(mbFormatGb(2*1024*1024 + 1024 + 111));
		System.out.println(kbFormatGb(2*1024*1024 + 1024 + 111));
		System.out.println(kbFormatGbMbKb(2*1024*1024 + 1024 + 111));
		System.out.println(bFormatGb(2359361536l));
		System.out.println(kbFormatGbMbKb(2359361536l));
		System.out.println("bbbbb" + bFormatGbMbKbB(235));
	}
	...
	public static String percent(String totalStr,String usedStr){
		
		Long total = totalStr==null?0:Long.parseLong(totalStr) ;
	    Long used = usedStr==null?0:Long.parseLong(usedStr);
	    
	    String percent = String.valueOf(Math.round(((double)used/(double)total)*100));
	    ...
	    String percent = numberFormat.format(Math.round(((double)used/(double)total)*100));
